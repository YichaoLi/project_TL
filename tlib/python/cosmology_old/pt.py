...
class Camb(utils.SpecialFunctions):
    ...
    """
    def __init__(self,iniName = 'cosmopy_camb.ini',cambPath = '../../workspace',
                 cambParam=None,**kws):
        """
    ...
    def pkInterp(self, knew, calcsplinecoeff = False):
        ...
        wn0 = N.where(knew > 0.)
        newy = 0.*knew
        newy[wn0] = M.exp(utils.splineIntLinExt(self.logpk, self.logk, M.log(knew[wn0]),splinecoeff = self.pkSplineCoeff))
        # do 0
        newy[w0] = 0.
        return newy
